<template>
    ...
    <div class="container p-3">
        ...
        <div class="d-flex flex-wrap">
            <div v-for="(device, ind) in deviceList" :key="ind" 
                ...
                <div class="row pt-4 pb-4 ps-5 pe-5 mt-2">
                ...
                <div class="col-6">
                    <button class="btn btn-outline-success w-100" @click="purchase(device)">Buy</button>
                </div>
            </div>
            </div>
        </div>
