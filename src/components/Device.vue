                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="device.price" 
                                    ...
                                    class="form-control" 
                                    required>
                            <div class="invalid-feedback">Price is required should be greater than 0.</div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="type">Device Type</label>
                                <select name=""
                                    ...
                                    <option v-for="(type, ind) in deviceType" :key="ind" :value="type" >{{type}}</option>
                                </select>
...
export default {
    ...
    setup(props, context) {
        ...
        const deviceType = ref([DeviceType.LAPTOP, DeviceType.PHONE, DeviceType.TABLET, DeviceType.DESKTOP])
    ...
    //         errorMessage: '',
    //         submitted: false,
    //         deviceType: [DeviceType.LAPTOP, DeviceType.PHONE, DeviceType.TABLET, DeviceType.DESKTOP],
    //     };
    // },
    // methods: {
    //     saveDevice() {
    //         if(!this.device.value.name || !this.device.price || !this.device.deviceType || !this.device.description) {
    //             return;
    //         }
